    ...
    {/* SUCCESS */}
      ...
      <section className="border-b border-gray-200 bg-white">
        <div className="mx-auto max-w-3xl px-5 py-14 text-center">
          ...
          <p className="mx-auto mt-3 max-w-xl text-sm leading-6 text-gray-500">
            Your order has been successfully placed. We’ll carefully
            inspect, pack and ship your device to you.
          </p>
      ...
      <section className="mx-auto max-w-5xl px-5 py-8 lg:px-8">
        ...
        <div className="mt-8 flex flex-col justify-center gap-3 sm:flex-row">
          <Link
            href="/buy"
            className="flex items-center justify-center gap-2 rounded-xl bg-indigo-600 px-6 py-3.5 text-sm font-bold text-white transition hover:bg-indigo-700"
          >
            Continue shopping
            <ArrowRight size={17} />
          </Link>
          ...
          <Link
            href="/"
            className="flex items-center justify-center gap-2 rounded-xl border border-gray-200 bg-white px-6 py-3.5 text-sm font-bold text-gray-700 transition hover:bg-gray-50"
          >
            <Home size={17} />
            Back to home
          </Link>
